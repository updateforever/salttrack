...
cfg.TRAIN.SEMANTIC_CONTRAST_WEIGHT = 0.0
cfg.TRAIN.SEMANTIC_CONTRAST_TAU = 0.07
cfg.TRAIN.SEMANTIC_CONTRAST_MODE = "v2t"  # v2t or bidirectional
cfg.TRAIN.SEMANTIC_HARD_NEG_WEIGHT = 0.0
cfg.TRAIN.SEMANTIC_HARD_NEG_TOPK = 8
cfg.TRAIN.SEMANTIC_HARD_NEG_MARGIN = 0.1
cfg.TRAIN.SEMANTIC_HARD_NEG_SUPPRESS_RADIUS = 0.15
cfg.TRAIN.SEMANTIC_HARD_NEG_SUPPRESS_POWER = 2.0
