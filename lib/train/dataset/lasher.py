...
class LasHeR(BaseVideoDataset):
    ...
    def _get_frame_path(self, seq_path, frame_id):
        ...
        # way2
        img_list = os.listdir(os.path.join(seq_path, 'visible'))
        img_list.sort()
        rgb_frame_path = os.path.join(seq_path, 'visible', img_list[frame_id])  # frames start from 0

        img_list = os.listdir(os.path.join(seq_path, 'infrared'))
        img_list.sort()
        ir_frame_path = os.path.join(seq_path, 'infrared', img_list[frame_id])
