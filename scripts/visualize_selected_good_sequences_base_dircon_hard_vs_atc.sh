...
/data/envs/wyp_vlt/bin/python tracking/visualization/visualize_selected_sequence_curves.py \
  ...
  --output output/visualizations/selected_good_sequences_base_dircon_hard_vs_atc/full_sequence_curves \
  --ours-yaml salttrack_base_full_dircon_hard \
  --ours-checkpoint output/checkpoints/train/salttrack/salttrack_base_full_dircon_hard/SALTTrack_ep0076.pth.tar \
